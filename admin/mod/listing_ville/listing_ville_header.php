<?php
    ...
    if(isset($_GET['id_suppr'])){
        ...
        sql_simple_delete('t_ville',$id_suppr);
        header('location: index.php?page=listing_ville');
    }

    $title_page = 'Listing des Villes';
    ...
    $html.= '   <a href="index.php?page=add_ville"><img src="pic/interface/add_ville.png"></a>';
    $html.= '</div>';
    ...
    if($rs && mysqli_num_rows($rs)){
        ...
        $html.= '       <td class="tab_td">Nom Ville</td>';
        ...
        while($data = mysqli_fetch_assoc($rs)){
            ...
            $html.= '            <a onclick="if(window.confirm(\'Etes vous sur ?\')) return true; else return false;" href="index.php?page=listing_ville&id_suppr='.$data['id'].'">';
            $html.= '                <img src="pic/interface/suppr.png">';
            $html.= '            </a>';
            $html.= '            <a href="index.php?page=add_ville&id='.$data['id'].'">';
